...
export default function Index() {
    ...
    const isAdministrador = auth.user.roles[0].name === 'administrador';
    ...
    return (
        <>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-2 ${isAdministrador ? 'lg:grid-cols-3' : 'lg:grid-cols-1'} gap-8`}>
                <div className='col-span-12 lg:col-span-2'>
                    <div className={`grid grid-cols-1 ${isAdministrador ? 'md:grid-cols-2' : 'md:grid-cols-3'} gap-4`}>
                        <CardOverview
