...
export default function IndividualReport() {
    ...
    return (
        <>
            ...
            <Card
                title={'Reporte de Planificación Individual'}
...
IndividualReport.layout = page => <AppLayout children={page}/>
