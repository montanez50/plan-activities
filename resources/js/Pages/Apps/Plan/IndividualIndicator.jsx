...
export default function IndividualIndicator() {
    ...
    const { users, years } = usePage().props;
    ...
    return (
        <>
            <Head title='Indicadores Individuales'/>
            <div className='mb-5'>
                <div className='flex flex-row items-center md:justify-between gap-5'>
                    <div className='lg:w-2/6 xl:w-1/6'>
                        <Button
                            ...
                            href={'/planification/dependency-indicators'}
                            added={true}
                        />
                    </div>
                </div>
            ...
            <Card
                title={'Indicadores de Planificación Individual'}
                ...
                <div className='grid grid-cols-3 gap-3'>
                    ...
                    <div className='mb-4'>
                        <SelectInput
                            label={'Usuario'}
                            options={users}
                            value={users.filter(e => e.value === user)[0]}
...
IndividualIndicator.layout = page => <AppLayout children={page}/>
